...
=======
* Included header files *
>>>>>>> 9343768881a8ca3b4dfbd915ccbea33a41646722
*************************/
#include "Wire.h"
...
#include "arduino_secrets.h"    //Contains password cridentials for connecting to 
...
---------------------------------------------------------------------------//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////  */
//SOIL MOISTURE.
const unsigned short MOISTURE_THRESHOLD_LOW = 1000;                  //Set moisture interval values. When measured moisture value (soil humidity) is within this interval soil moisture is considered to be OK for plants.
const unsigned short MOISTURE_THRESHOLD_HIGH = 1010;                 //Same as above but upper threshold for what is considered to be OK soil humidity.
...
/*
.........................................................................................................../////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
Oliver Staberg at ALTEN Sweden AB in cooperation with Västsvenska Handelskammaren. Gothenburg, April 2019. //
/////////////////////////////////////////////////////////////////////////////////////////////////////////////
/* 
>>>>>>> 9343768881a8ca3b4dfbd915ccbea33a41646722
...
bool moistureDry = false;                 //Activates warning message on display based on moisture mean value. 'true' if soil for mean value sensor is too dry.
bool moistureWet = false;                 //Activates warning message on display based on moisture mean value. 'true' if soil for mean value sensor is too wet.
//const unsigned int MOISTURE_THRESHOLD_LOW = 300;
>>>>>>> 9343768881a8ca3b4dfbd915ccbea33a41646722
...
=======
unsigned int CHECK_LIGHT_NEED_PERIOD = 5000;   //Loop time for how often measured light value is checked. This enables/disables start of LED lighting.
unsigned long checkLightNeedStart = 0;
//unsigned int CHECK_LIGHT_FAULT_PERIOD = 3000;  //Delay time after LED lighting has been turned ON, before checking if it works.
unsigned long checkLightFaultStart = 0;
>>>>>>> 9343768881a8ca3b4dfbd915ccbea33a41646722
...
char         cloudUser[]    = CLOUD_USER;    // your cloud login username
char         cloudPass[]    = CLOUD_PASS;    // your cloud login password

const String TemperatureKey = "mathivation_gh/3303/0/5700";
const String HumidityKey    = "mathivation_gh/3304/0/5700";
char         server[]       = "iotgarage.expericom.ericsson.net";
...
<<<<<<< HEAD
  ...
  ****************************************************/
  if (clockStartMode == true) {          //Check if internal clock is enabled to run.
    ...
    unsigned short clockTime1, clockTime2;
...
=======
  ...
  stringToDisplay(11, 0, "Press SET-button");
  stringToDisplay(12, 0, "and keep it");
  stringToDisplay(13, 0, "pressed until it");
  stringToDisplay(14, 0, "says 'YES'.");
  stringToDisplay(15, 0, "Restart: ");
...
String connectAndLogin(String username, String password) {
  String message = "{\"email\": \"" + username + "\", \"password\": \"" + password + "\"}";
  ...
  if (client.connect(server, 80)) {
    ...
    client.println("Host: iotgarage.expericom.ericsson.net");
...
bool connectAndSetValue(String authToken, String key, float val) {
  String message = "{\"measurements\": [{\"url\": \"" + key + "\", \"value\": \"" + String(val) + "\"}]}";
  Serial.println("\nConnecting to server...");
  ...
  // Print the full response only for debugging
...
void postToServer(String authToken, String key, float val) {
  if ((authToken.length() > 0) && connectAndSetValue(authToken, key, val))
